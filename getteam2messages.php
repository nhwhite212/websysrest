...
{$user_id = 0;}
  ...
  /* connect to the db */
  $link = mysql_connect('websys3.stern.nyu.edu','websysF14UB2','websysF14UB2!!') or die('Cannot connect to the DB');
  mysql_select_db('websysF14UB2',$link) or die('Cannot select the DB');
